...
export const STRINGS: Record<UiLocale, CopyBlock> = {
  zh: {
    ...
    uploadHint: "最大 {maxMb}MB · 自动压缩至 10MB",
    tipTitle: "剪辑建议",
    tipBody:
    ...
    needVideo: "请先选择视频",
    stillLarge: "视频仍超过 10MB，请重新选择或等待压缩完成",
    canceled: "已取消分析",
  ...
  en: {
    ...
    uploadHint: "Up to {maxMb}MB · auto-compress to 10MB",
    tipTitle: "Editing tip",
    tipBody:
      "Keep only the crux move; clips under 10MB and ~90s analyze more reliably.",
    ...
    stillLarge: "Still over 10MB—wait for compression or pick another file",
